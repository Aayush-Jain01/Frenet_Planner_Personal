...
def main(args=None):
    ...
    occupancy_grid_publisher = node.create_publisher(OccupancyGrid,'/move_base/local_costmap/costmap',10)
    footprint_publisher = node.create_publisher(PolygonStamped,'move_base/local_costmap/footprint',10)
