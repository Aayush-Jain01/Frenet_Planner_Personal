...
// Waypoints
static vector<double> W_X = {38, 38, 38, 38, 38, 38, 38 , 38.21, 39.25, 42.56, 48.97, 61};
static vector<double> W_Y = {-57, -45, -32.0, -18.5, -12.0, 0.0, 12, 35, 42.89, 80.41, 131.48, 139.47};
