...
// Parameter
static double MAX_SPEED;  // maximum speed [m/s]
static double MAX_ACCEL;  // maximum acceleration [m/ss]
static double MAX_CURVATURE;  // maximum curvature [1/m]
static double MAX_ROAD_WIDTH;  // maximum road width [m]
static double D_ROAD_W;  // road width sampling length [m]
static double DT;  // time tick [s]
static double MAXT;  // max prediction time [m]
static double MINT;  // min prediction time [m]
static double TARGET_SPEED;  // target speed [m/s]
static double D_T_S;  // target speed sampling length [m/s]
static double N_S_SAMPLE;  // sampling number of target speed
static double ROBOT_RADIUS;  // robot radius [m]
static double MIN_LAT_VEL;  // minimum lateral speed. Sampling for d_dot
static double MAX_LAT_VEL;  // maxmum lateral speed. Sampling for d_dot
static double D_D_NS;  // Step size for sampling of d_dot
static double MAX_SHIFT_D;  // Sampling width for sampling of d.
