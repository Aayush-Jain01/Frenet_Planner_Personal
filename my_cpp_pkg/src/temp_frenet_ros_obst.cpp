...
// 		wx = this->get_parameter("/frenet_planner/waypoints/W_X", W_X);
// 		wy = this->get_parameter("/frenet_planner/waypoints/W_Y", W_Y);
// 		target_speed = this->get_parameter("/frenet_planner/path/target_speed", TARGET_SPEED);
// 	}
...
// 		tf2::Quaternion q = tf2::createQuaternionFromRPY(0, 0, yaw); // roll , pitch = 0
// 		q.normalize();
...
public:  
    ...
    : Node("frenet_class")
    {
        ...
        costmap_sub = this->create_subscription<nav_msgs::msg::OccupancyGrid>("/move_base/local_costmap/costmap", 10000, std::bind(&FrenetClass::costmap_callback, this, _1));

		this->get_parameter("/frenet_planner/waypoints/W_X", W_X);
		this->get_parameter("/frenet_planner/waypoints/W_Y", W_Y);
		this->get_parameter("/frenet_planner/path/target_speed", TARGET_SPEED);
		wx = W_X;
		wy = W_Y;
